...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        for j in range(len(opponent.deck.cards) - 1, -1, -1):
            if opponent.deck.cards[j].attack == opponent_card.attack or opponent.deck.cards[j].defense == opponent_card.defense:
