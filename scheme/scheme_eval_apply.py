...
def eval_all(expressions, env):
    ...
    current = expressions.rest
    while (current is not nil):
        last_result = scheme_eval(current.first, env)
        current = current.rest
    return last_result  # replace this with lines of your own code
    # END PROBLEM 6
